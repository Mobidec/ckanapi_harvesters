...
from ckanapi_harvesters.ckan_api.ckan_api_7_sysadmin import CkanApiSysadmin as CkanApi  # alias
from ckanapi_harvesters.ckan_api.ckan_api_7_sysadmin import CkanApiSysadminParams as CkanApiParams  # alias
